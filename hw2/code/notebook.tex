...
{\color{incolor}In [{\color{incolor}11}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np} \PY{c+c1}{\PYZsh{} for doing most of our calculations}
...
The autoreload extension is already loaded. To reload it, use:
  \%reload\_ext autoreload
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{} Set the path to the CIFAR\PYZhy{}10 data}
...
Test labels shape:  (10000,)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{} Visualize some examples from the dataset.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{} Subsample the data for more efficient code execution in this exercise}
...
hyperparameters via k-fold cross-validation.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{\PYZsh{} Import the KNN class}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{c+c1}{\PYZsh{} Declare an instance of the knn class.}
...
\def\labelenumi{(\arabic{enumi})}
\item
  In the function knn.train, it just simply saves data X\_train and
  labels y\_train inside the function.
\item
  Pros: it has low time complexity. Cons: it has high space complexity.
\end{enumerate}
...
information, predict the class of the KNN.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{\PYZsh{} Implement the function compute\PYZus{}distances() in the KNN class.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Time to run code: 90.02728343009949
...
code by vectorizing it, removing the for loops.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{} Implement the function compute\PYZus{}L2\PYZus{}distances\PYZus{}vectorized() in the KNN class.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Time to run code: 0.36796116828918457
...
predict the test point labels.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{c+c1}{\PYZsh{} Implement the function predict\PYZus{}labels in the KNN class.}
         ...
         \PY{k}{for} \PY{n}{index}\PY{p}{,}\PY{n}{t} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{dists\PYZus{}L2\PYZus{}vectorized}\PY{p}{)}\PY{p}{:}
             \PY{n}{minindex} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{where}\PY{p}{(}\PY{n}{t} \PY{o}{==} \PY{n+nb}{min}\PY{p}{(}\PY{n}{t}\PY{p}{)}\PY{p}{)}
             \PY{k}{if} \PY{n}{y\PYZus{}test}\PY{p}{[}\PY{n}{index}\PY{p}{]} \PY{o}{!=} \PY{n}{y\PYZus{}train}\PY{p}{[}\PY{n}{minindex}\PY{p}{]}\PY{p}{:}
                 \PY{n}{error} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
         \PY{n}{error} \PY{o}{=} \PY{n}{error}\PY{o}{/} \PY{n}{X\PYZus{}test}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
...
k-fold cross validation.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{} Create the dataset folds for cross\PYZhy{}valdiation.}
         ...
         \PY{n}{indexes} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}
         \PY{n}{random}\PY{o}{.}\PY{n}{shuffle}\PY{p}{(}\PY{n}{indexes}\PY{p}{)}
         \PY{n}{length1} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{/}\PY{n}{num\PYZus{}folds}\PY{p}{)}
         \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{num\PYZus{}folds}\PY{p}{)}\PY{p}{:}
             \PY{k}{if} \PY{n}{i} \PY{o}{!=} \PY{n}{num\PYZus{}folds}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{:}
                 \PY{n}{X\PYZus{}train\PYZus{}folds}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{indexes}\PY{p}{[}\PY{n}{i}\PY{o}{*}\PY{n}{length1}\PY{p}{:}\PY{p}{(}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{*}\PY{n}{length1}\PY{p}{]}\PY{p}{)}\PY{p}{]}\PY{p}{)}
                 \PY{n}{y\PYZus{}train\PYZus{}folds}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{indexes}\PY{p}{[}\PY{n}{i}\PY{o}{*}\PY{n}{length1}\PY{p}{:}\PY{p}{(}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{o}{*}\PY{n}{length1}\PY{p}{]}\PY{p}{)}\PY{p}{]}\PY{p}{)}
             \PY{k}{else}\PY{p}{:}
                 \PY{n}{X\PYZus{}train\PYZus{}folds}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{indexes}\PY{p}{[}\PY{n}{i}\PY{o}{*}\PY{n}{length1}\PY{p}{:}\PY{p}{]}\PY{p}{)}\PY{p}{]}\PY{p}{)}
                 \PY{n}{y\PYZus{}train\PYZus{}folds}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{[}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{indexes}\PY{p}{[}\PY{n}{i}\PY{o}{*}\PY{n}{length1}\PY{p}{:}\PY{p}{]}\PY{p}{)}\PY{p}{]}\PY{p}{)}
...
assess which one has the lowest k-fold cross validation error.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{k+kn}{import} \PY{n+nn}{collections}
         \PY{n}{time\PYZus{}start} \PY{o}{=}\PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}
         ...
         \PY{c+c1}{\PYZsh{} ================================================================ \PYZsh{}}
         \PY{n}{knn} \PY{o}{=} \PY{n}{KNN}\PY{p}{(}\PY{p}{)}
         \PY{n}{error\PYZus{}total} \PY{o}{=} \PY{p}{[}\PY{p}{]}
         \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n}{ks}\PY{p}{:}
             \PY{n}{sub\PYZus{}error} \PY{o}{=} \PY{p}{[}\PY{p}{]}
             \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{)}\PY{p}{:}
                 ...
                 \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{)}\PY{p}{:}
                     \PY{k}{if} \PY{n}{j} \PY{o}{!=} \PY{n}{i}\PY{p}{:}
                         \PY{n}{training} \PY{o}{=}  \PY{n}{training} \PY{o}{+} \PY{n+nb}{list}\PY{p}{(}\PY{n}{X\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{)}
                         \PY{n}{label} \PY{o}{=} \PY{n}{label} \PY{o}{+} \PY{n+nb}{list}\PY{p}{(}\PY{n}{y\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{)}
                 \PY{k}{assert}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{label}\PY{p}{)} \PY{o}{==} \PY{l+m+mi}{4000}\PY{p}{)}
                 \PY{n}{validation\PYZus{}data} \PY{o}{=} \PY{n}{X\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{i}\PY{p}{]}
                 \PY{n}{validation\PYZus{}label} \PY{o}{=} \PY{n}{y\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{i}\PY{p}{]}
                 \PY{n}{knn}\PY{o}{.}\PY{n}{train}\PY{p}{(}\PY{n}{X}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{training}\PY{p}{)}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{label}\PY{p}{)}\PY{p}{)}
                 \PY{n}{dists\PYZus{}L2\PYZus{}vectorized} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{compute\PYZus{}L2\PYZus{}distances\PYZus{}vectorized}\PY{p}{(}\PY{n}{X}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{validation\PYZus{}data}\PY{p}{)}\PY{p}{)}
                 \PY{n}{error} \PY{o}{=} \PY{l+m+mi}{0}
                 \PY{n}{y\PYZus{}pred} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{predict\PYZus{}labels}\PY{p}{(}\PY{n}{dists\PYZus{}L2\PYZus{}vectorized}\PY{p}{,}\PY{n}{k}\PY{p}{)}
                 
                 \PY{n}{error} \PY{o}{=} \PY{n+nb}{sum}\PY{p}{(}\PY{n}{y\PYZus{}pred} \PY{o}{!=} \PY{n}{validation\PYZus{}label}\PY{p}{)} \PY{o}{/} \PY{n}{validation\PYZus{}label}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
                 \PY{n}{sub\PYZus{}error}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{error}\PY{p}{)}
             \PY{n}{error\PYZus{}total}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{sub\PYZus{}error}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Computation time: 57.30

    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{n}{error\PYZus{}total}
\end{Verbatim}
...
performance.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{n}{time\PYZus{}start} \PY{o}{=}\PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}
         ...
         \PY{k}{for} \PY{n}{norm} \PY{o+ow}{in} \PY{n}{norms}\PY{p}{:}
             ...
             \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{)}\PY{p}{:}
                 ...
                 \PY{n}{validation\PYZus{}label} \PY{o}{=} \PY{n}{y\PYZus{}train\PYZus{}folds}\PY{p}{[}\PY{n}{i}\PY{p}{]}
                 \PY{n}{knn}\PY{o}{.}\PY{n}{train}\PY{p}{(}\PY{n}{X}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{training}\PY{p}{)}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{label}\PY{p}{)}\PY{p}{)}
                 \PY{n}{dists} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{compute\PYZus{}distances}\PY{p}{(}\PY{n}{X}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{validation\PYZus{}data}\PY{p}{)}\PY{p}{,}\PY{n}{norm}\PY{o}{=}\PY{n}{norm}\PY{p}{)}
                 \PY{n}{error} \PY{o}{=} \PY{l+m+mi}{0}
                 \PY{n}{y\PYZus{}pred} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{predict\PYZus{}labels}\PY{p}{(}\PY{n}{dists}\PY{p}{,}\PY{n}{k} \PY{o}{=} \PY{l+m+mi}{15}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Computation time: 1112.92

    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{n}{error\PYZus{}total}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}24}]:} [0.6876, 0.7142000000000001, 0.8315999999999999]
\end{Verbatim}
...
\def\labelenumi{(\arabic{enumi})}
\item
  The best norm is L-1 norm.
\item
  The best cross-validation error is 0.6876.
\end{enumerate}
...
evaluate the testing error of the k-nearest neighbors model.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{n}{error} \PY{o}{=} \PY{l+m+mi}{1}
         ...
         \PY{n}{knn}\PY{o}{.}\PY{n}{train}\PY{p}{(}\PY{n}{X} \PY{o}{=} \PY{n}{X\PYZus{}train}\PY{p}{,}\PY{n}{y} \PY{o}{=} \PY{n}{y\PYZus{}train}\PY{p}{)}
         \PY{n}{dists} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{compute\PYZus{}distances}\PY{p}{(}\PY{n}{X}\PY{o}{=}\PY{n}{X\PYZus{}test}\PY{p}{,}\PY{n}{norm}\PY{o}{=}\PY{n}{norms}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
         \PY{n}{y\PYZus{}pred} \PY{o}{=} \PY{n}{knn}\PY{o}{.}\PY{n}{predict\PYZus{}labels}\PY{p}{(}\PY{n}{dists}\PY{p}{,}\PY{n}{k} \PY{o}{=} \PY{l+m+mi}{15}\PY{p}{)}
         \PY{n}{error} \PY{o}{=} \PY{n+nb}{sum}\PY{p}{(}\PY{n}{y\PYZus{}pred} \PY{o}{!=} \PY{n}{y\PYZus{}test}\PY{p}{)} \PY{o}{/} \PY{n}{y\PYZus{}test}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
